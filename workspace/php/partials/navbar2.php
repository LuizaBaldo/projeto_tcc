            ...
            <div class="headerTitle"><h2>Adot.org</h2></div>
                ...
                <?php
                    if(isset($_SESSION["nome_usuario"])==false){
                        ...
                        echo "<button class='btn text-white dropdown-toggle' type='button' id='dropdownMenuButton1' data-bs-toggle='dropdown' aria-expanded='false' style='background-color:  #66C4A9;'>Olá, $nome_usuario</button>";
